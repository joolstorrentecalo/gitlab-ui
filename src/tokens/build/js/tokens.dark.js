...
export const GL_PROGRESS_BAR_INDICATOR_COLOR_DEFAULT = '#428fdc'; // Used for the indicator color for the primary progress-bar type.
export const GL_PROGRESS_BAR_INDICATOR_COLOR_SUCCESS = '#2da160'; // Used for the indicator color for the success progress-bar type.
export const GL_PROGRESS_BAR_INDICATOR_COLOR_WARNING = '#c17d10'; // Used for the indicator color for the warning progress-bar type.
export const GL_PROGRESS_BAR_INDICATOR_COLOR_DANGER = '#ec5941'; // Used for the indicator color for the danger progress-bar type.
