...
export const GL_DROPDOWN_OPTION_INDICATOR_COLOR_DEFAULT = '#63a6e9'; // Used for the background of a dropdown option indicator in the default state.
export const GL_DROPDOWN_OPTION_INDICATOR_COLOR_HOVER = '#9dc7f1'; // Used for the background of a dropdown option indicator in the hover state.
export const GL_DROPDOWN_OPTION_INDICATOR_COLOR_FOCUS = '#9dc7f1'; // Used for the background of a dropdown option indicator in the focus state.
export const GL_DROPDOWN_OPTION_INDICATOR_COLOR_ACTIVE = '#9dc7f1'; // Used for the background of a dropdown option indicator in the active state.
export const GL_DROPDOWN_OPTION_UNSELECTED_BACKGROUND_COLOR_DEFAULT = 'rgba(137, 136, 141, 0.0)'; // Used for the background of an unselected dropdown option in the default state.
export const GL_DROPDOWN_OPTION_UNSELECTED_BACKGROUND_COLOR_HOVER = 'rgba(137, 136, 141, 0.4)'; // Used for the background of an unselected dropdown option in the hover state.
export const GL_DROPDOWN_OPTION_UNSELECTED_BACKGROUND_COLOR_FOCUS = 'rgba(137, 136, 141, 0.4)'; // Used for the background of an unselected dropdown option in the focus state.
export const GL_DROPDOWN_OPTION_UNSELECTED_BACKGROUND_COLOR_ACTIVE = 'rgba(137, 136, 141, 0.16)'; // Used for the background of an unselected dropdown option in the active state.
export const GL_DROPDOWN_OPTION_SELECTED_BACKGROUND_COLOR_DEFAULT = '#28272d'; // Used for the background of an selected dropdown option in the default state.
export const GL_DROPDOWN_OPTION_SELECTED_BACKGROUND_COLOR_HOVER = '#3a383f'; // Used for the background of an selected dropdown option in the hover state.
export const GL_DROPDOWN_OPTION_SELECTED_BACKGROUND_COLOR_FOCUS = '#3a383f'; // Used for the background of an selected dropdown option in the focus state.
export const GL_DROPDOWN_OPTION_SELECTED_BACKGROUND_COLOR_ACTIVE = '#4c4b51'; // Used for the background of an selected dropdown option in the active state.
