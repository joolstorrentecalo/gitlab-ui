...
export const GL_DROPDOWN_OPTION_INDICATOR_COLOR_DEFAULT = '#1f75cb'; // Used for the background of a dropdown option indicator in the default state.
export const GL_DROPDOWN_OPTION_INDICATOR_COLOR_HOVER = '#0b5cad'; // Used for the background of a dropdown option indicator in the hover state.
export const GL_DROPDOWN_OPTION_INDICATOR_COLOR_FOCUS = '#0b5cad'; // Used for the background of a dropdown option indicator in the focus state.
export const GL_DROPDOWN_OPTION_INDICATOR_COLOR_ACTIVE = '#0b5cad'; // Used for the background of a dropdown option indicator in the active state.
export const GL_DROPDOWN_OPTION_UNSELECTED_BACKGROUND_COLOR_DEFAULT = 'rgba(164, 163, 168, 0.0)'; // Used for the background of an unselected dropdown option in the default state.
export const GL_DROPDOWN_OPTION_UNSELECTED_BACKGROUND_COLOR_HOVER = 'rgba(164, 163, 168, 0.16)'; // Used for the background of an unselected dropdown option in the hover state.
export const GL_DROPDOWN_OPTION_UNSELECTED_BACKGROUND_COLOR_FOCUS = 'rgba(164, 163, 168, 0.16)'; // Used for the background of an unselected dropdown option in the focus state.
export const GL_DROPDOWN_OPTION_UNSELECTED_BACKGROUND_COLOR_ACTIVE = 'rgba(83, 81, 88, 0.24)'; // Used for the background of an unselected dropdown option in the active state.
export const GL_DROPDOWN_OPTION_SELECTED_BACKGROUND_COLOR_DEFAULT = '#ececef'; // Used for the background of an selected dropdown option in the default state.
export const GL_DROPDOWN_OPTION_SELECTED_BACKGROUND_COLOR_HOVER = '#dcdcde'; // Used for the background of an selected dropdown option in the hover state.
export const GL_DROPDOWN_OPTION_SELECTED_BACKGROUND_COLOR_FOCUS = '#dcdcde'; // Used for the background of an selected dropdown option in the focus state.
export const GL_DROPDOWN_OPTION_SELECTED_BACKGROUND_COLOR_ACTIVE = '#bfbfc3'; // Used for the background of an selected dropdown option in the active state.
